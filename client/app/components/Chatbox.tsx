...
import { MessageCircle, Plus, Clock, Search, Archive } from "lucide-react";
...
export default function ChatBox() {
  ...
  const { data: currentConversation } = useGetConversationQuery(conversationId!, {
    skip: !conversationId,
  });
  ...
  return (
    <div className="flex h-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <aside className="w-80 flex flex-col bg-white/80 backdrop-blur-sm border-r border-gray-200/50 shadow-2xl">
      ...
      <main className="flex-1 flex flex-col bg-gradient-to-br from-blue-50 via-indigo-50 via-purple-50 to-pink-50 relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto p-4 lg:p-6 flex flex-col flex-1">
          <ChatHeader />
          <StatsCards />
